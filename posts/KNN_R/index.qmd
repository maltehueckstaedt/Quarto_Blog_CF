...
Dataset: First, a dataset is required, which consists of a collection of data points. Each data point has features that define its position in space.
...
![Illustration of the procedure of the K-NN algorithm. **Source:** [Diego Inácio](https://diegoinacio.github.io/projects.html)](KNN.gif){#fig-knn fig-align="center" width="800"}
